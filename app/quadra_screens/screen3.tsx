...
// export default function Screen3() {
//   const router = useRouter();
//   const { valveName, nodeId } = useLocalSearchParams();
...
//   // Fetch stored schedule from MySQL when component loads
//   useEffect(() => {
//     const fetchSchedule = async () => {
//       try {
//         const response = await fetch(`${API_URL}/get-schedule?node_id=${nodeId}&valve_name=${valveName}`);
//         const data = await response.json();

//         if (data) {
//           setDuration(data.duration);
//           setData(new Date(data.timestamp).toLocaleString());
//         }
//       } catch (error) {
...
//   return (
//     <View style={{ flex: 1, alignItems: 'center', backgroundColor: '#f0f0f0', padding: 20 }}>
//       {/* HEADER */}
//       <View style={{ width: '100%', backgroundColor: 'white', paddingVertical: 10, alignItems: 'center', elevation: 4 }}>
//         <Text style={{ fontSize: 22, fontWeight: 'bold' }}>Watering History</Text>
//       </View>

//       {/* Display Latest Schedule */}
//       <View style={{ marginTop: 30, width: '100%', alignItems: 'center' }}>
//         <Text style={{ fontSize: 18, fontWeight: 'bold' }}>Node: {nodeId} - {valveName}</Text>
//         <Text style={{ fontSize: 16, marginTop: 10 }}>Duration: {duration ? `${duration} min` : 'Loading...'}</Text>
//         <Text style={{ fontSize: 16, marginTop: 5 }}>Time: {timestamp || 'Loading...'}</Text>
//       </View>
//     </View>
//   );
// }
